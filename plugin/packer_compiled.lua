...
local no_errors, error_msg = pcall(function()
	...
	_G.packer_plugins = {
		...
		["hardline-jjir"] = {
			loaded = true,
			path = "/Users/jj/.local/share/nvimjj/site/pack/packer/start/hardline-jjir",
			url = "https://github.com/jasonjurotich/hardline-jjir",
		},
